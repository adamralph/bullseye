...
dotnet run -c Release --no-build --project BullseyeSmokeTester.DragonFruit  -- --help || goto :error
dotnet run -c Release --no-build --project BullseyeSmokeTester.DragonFruit  -- --foo bar --verbose --targets build || goto :error
