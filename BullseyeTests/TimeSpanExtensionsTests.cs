namespace BullseyeTests
{
    ...
    public class TimeSpanExtensionsTests
    {
        ...
        [Example(0.9D, "<1 ms")]
        [Example(1D, "1 ms")]
        [Example(1.234D, "1.23 ms")]
        [Example(123.4D, "123 ms")]
        [Example(1_000D, "1 s")]
        [Example(1_234D, "1.23 s")]
        [Example(12_340D, "12.3 s")]
        [Example(60_000D, "1 m")]
        ...
        public void FixedPointHumanization(double milliseconds, string expected, TimeSpan? timeSpan, string actual)
        {
            $"Given a timespan of {milliseconds} milliseconds"
                .x(() => timeSpan = TimeSpan.FromMilliseconds(milliseconds));

            $"When humanizing the timespan"
                .x(() => actual = timeSpan.Humanize(true));
