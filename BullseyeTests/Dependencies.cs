    ...
    public class Dependencies
    {
        ...
        public void FlatDependencies(TargetCollection targets, List<string> ran)
        {
            ...
            "When I run the third target"
                .x(() => targets.RunAsync(new List<string> { "third" }, default, default, default, default));
        ...
        public void DoubleDependency(TargetCollection targets, List<string> ran)
        {
            ...
            "When I run the second target"
                .x(() => targets.RunAsync(new List<string> { "second" }, default, default, default, default));
        ...
        public void SelfDependency(TargetCollection targets, Exception exception)
        {
            ...
            "When I run the target"
                .x(async () => exception = await Record.ExceptionAsync(() => targets.RunAsync(new List<string> { "first" }, default, default, default, default)));
        ...
        public void MutualDependency(TargetCollection targets, Exception exception)
        {
            ...
            "When I run the second target"
                .x(async () => exception = await Record.ExceptionAsync(() => targets.RunAsync(new List<string> { "second" }, default, default, default, default)));
        ...
        public void CircularDependency(TargetCollection targets, Exception exception)
        {
            ...
            "When I run the third target"
                .x(async () => exception = await Record.ExceptionAsync(() => targets.RunAsync(new List<string> { "third" }, default, default, default, default)));
        ...
        public void SkippingDependencies(TargetCollection targets, List<string> ran)
        {
            ...
            "When I run the second target, skipping dependencies"
                .x(() => targets.RunAsync(new List<string> { "second", "-s" }, default, default, default, default));
        ...
        public void DependencyOrderWhenSkipping(TargetCollection targets, List<string> ran)
        {
            ...
            "When I run the second and first targets, skipping dependencies"
                .x(() => targets.RunAsync(new List<string> { "--skip-dependencies", "second", "first" }, default, default, default, default));
            ...
            int test2StartTime)
        {
            ...
            "When I run all the targets with parallelism, skipping dependencies"
                .x(() => targets.RunAsync(new List<string> { "--parallel", "--skip-dependencies", "test1", "test2", "build" }, default, default, default, default));
